...
Write-Host "LIKE ALL GOOGLE PRODUCTS, CHROMIUM SHOULD BE CONSIDERED PROFESSIONALLY BUILT AND MANAGED SPYWARE. GOOGLE IS PART OF THE US PRISM PROGRAM AND SUBJECT TO US LAWS."

Write-Host "`n"

Write-Host "USE WITH CAUTION AND DO NOT INSTALL THIS OR ANY OTHER GOOGLE SOFTWARE ON ANY SENSITIVE SYSTEMS."
